...
/* NOTE: class is "goalring", NOT "ring". The bare class name "ring" collides with
   Tailwind's `.ring` utility (loaded from the CDN in index.html), which paints a
   3px box-shadow in the default ring colour (blue-500). On this rectangular div
   that rendered as a blue square around the XP ring. Do not rename it back to
   "ring" or any other Tailwind utility name. */
.ed .goalring{ position:relative; width:84px; height:84px; margin:6px auto 8px; }
.ed .goalring svg{ display:block; }
.ed .goalring .n{ position:absolute; inset:0; display:flex; flex-direction:column; align-items:center; justify-content:center; }
.ed .goalring .n b{ font-size:18px; font-weight:800; }
.ed .goalring .n small{ font-size:8.5px; color:var(--faint); text-transform:uppercase; letter-spacing:0.08em; }
