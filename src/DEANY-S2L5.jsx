  ...
  return <div className="grid gap-5">
    <section className="overflow-hidden rounded-[1.75rem] bg-[#102033] p-7 text-white shadow-[0_22px_55px_rgba(15,23,42,0.16)] sm:p-10">
      ...
      <div className="mt-7 grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        ...
        <div className="rounded-[1.75rem] border border-white/15 bg-white/[0.07] p-5 shadow-inner"><p className="text-xs font-black uppercase tracking-[0.18em] text-amber-200">Sahih anchor</p><blockquote className="mt-3 text-xl font-black leading-9 text-white">The Prophet ﷺ taught: cast aside doubt and build on what is certain.</blockquote><p className="mt-4 text-sm font-semibold text-white/60">Sahih Muslim 571a. Used here because this lesson teaches how to handle mistakes and doubt in salah.</p></div>
      </div>
    </section>
...
export default function DEANYS2L5({ onBack, onHome }) {
  const saved = load() || {};
  ...
  const pages = [
    ...
    <Results key="results" scores={scores} total={total} />,
  ];
