  ...
  const modules = {
    ...
    'islamic-finance': [{
      ...
      lessons: [
        ...
        { id: 'lesson-1-3', title: "Quick Map: Riba, Gharar, Maysir", description: "Diagnosing the three major prohibitions", duration: "12 min", questions: [] },
        { id: 'lesson-1-4', title: "Riba Types & Currency Basics (Sarf)", description: "Fadl, nasi'ah, and currency exchange rules", duration: "12 min", questions: [] },
        { id: 'lesson-1-5', title: "Gharar in Practice (Salam & Istisna')", description: "Buying what doesn't exist yet -- correctly", duration: "12 min", questions: [] },
        { id: 'lesson-1-6', title: "Governance, Screening & Purification", description: "SSB oversight, equity screening, and tathir", duration: "12 min", questions: [] }
      ]
    },
