  ...
  lessons: [
    ...
    { id: 'lesson-2-1', title: "Valid Sale: Pillars & Conditions", description: "The five pillars every sale needs", duration: "12 min",
      ...
      questions: [
        ...
        { question: "Complete: (1) Offer & ______, (2) Lawful & specified subject, (3) Known price, (4) Ability to deliver, (5) Absence of riba, gharar & ______.", type: "multiple-choice", uiType: "fill", xp: 10, zone: 1,
          hint: "One option repeats a word already in the question stem.",
        ...
        { question: "Select TWO non-negotiable elements for this sale to be valid.", concept: "Reviewing a second-hand camera contract on Dubizzle.", type: "multi-select", uiType: "sel2", xp: 10, zone: 1,
          ...
          correct: [0, 2],
          explanation: "Specified subject and known price are structural. Written contracts and return policies are protections, not validity pillars.",
          trapAnalysis: "'Written contract' sounds legally essential but Islamic validity doesn't require writing. 'Return policy' plays on consumer-rights expectations. Not a pillar." },
    ...
    { id: 'lesson-2-2', title: "Ownership & Possession", description: "Don't sell what you don't own", duration: "12 min",
      ...
      questions: [
        ...
        { question: "What single question best tests valid possession?", type: "multiple-choice", uiType: "fill", xp: 10, zone: 1,
        ...
        { question: "Put a murabaha smartphone purchase in the correct sequence:", type: "multiple-choice", uiType: "flow-tap", xp: 15, zone: 2,
          options: ["You pay → Bank sells → Bank buys → You identify", "You identify → Bank buys & owns → Bank sells at cost + markup → You pay", "Bank sells → You identify → You pay → Bank buys", "Bank buys → You pay → Bank sells → You identify"],
          correct: 1,
          explanation: "Identify → bank acquires → bank sells → you pay. Bank MUST own before selling.",
          visual: {steps: [{num: 1, title: "You identify the phone you want", ok: true}, {num: 2, title: "Bank purchases and takes ownership from retailer", ok: true}, {num: 3, title: "Bank sells to you at cost + agreed markup (fixed total price)", ok: true}, {num: 4, title: "You pay according to instalment schedule", ok: true}]} },

        { question: "Audit a bank's murabaha product. Sort: Valid vs Defective.", concept: "Features: Bank buys and owns item first | Sale price fixed upfront | Bank sells from catalogue without owning | Internal docs label payments as 'interest'", type: "column-sort", uiType: "drag-alloc", xp: 15, zone: 2,
          columns: [{id: "valid", label: "Keeps Murabaha Valid", color: "#059669", correct: ["Bank buys and owns the item first", "Sale price (cost + markup) fixed upfront"]}, {id: "defective", label: "Structural Defect", color: "#dc2626", correct: ["Bank sells from catalogue without owning", "Internal docs call payments 'interest'"]}],
          visual: { buckets: [{id: "valid", label: "Valid", color: "#059669"}, {id: "defective", label: "Defective", color: "#dc2626"}], chips: [{text: "Bank buys and owns the item first", correct: "valid"}, {text: "Sale price (cost + markup) fixed upfront", correct: "valid"}, {text: "Bank sells from catalogue without owning", correct: "defective"}, {text: "Internal docs call payments 'interest'", correct: "defective"}] },
          explanation: "Murabaha requires real ownership before resale. 'Interest' labelling reveals substance may be a loan.",
        ...
        { question: "Who can resell?", concept: "Seller A: Paid, title held, insured, goods in manufacturer warehouse. Seller B: Paid, title held, insured, goods in bonded warehouse awaiting customs.", type: "multiple-choice", uiType: "compare", xp: 15, zone: 2,
          ...
          visual: {cards: [{title: "SELLER A", neutralLines: ["Paid in full for 500 laptops", "Holds title and commercial invoice", "Insurance in her name", "Goods in manufacturer warehouse", "Pickup: next Tuesday"]}, {title: "SELLER B", neutralLines: ["Paid in full for 1,000 tablets", "Holds title and commercial invoice", "Insurance in her name", "Goods in bonded warehouse", "Customs clearance: pending"]}]} },
    ...
    { id: 'lesson-2-3', title: "Risk Before Profit", description: "No risk = no legitimate return", duration: "12 min",
      conceptCards: [
        { title: "The risk–return principle", text: "al-ghurm bil-ghunm / al-kharāj bil-ḍamān: entitlement to gain follows exposure to loss.\n\nBackbone of Islamic commercial law. No risk = no legitimate return.\n\nIf your 'profit' comes without skin in the game, it resembles ribā.",
          proTip: "If you can't lose, you can't legitimately earn." },
      ...
      questions: [
        // --- ZONE 1: WARM-UP (Q1-3) ---
        { question: "Complete: 'Entitlement to benefit follows ______.'", type: "multiple-choice", uiType: "fill", xp: 10, zone: 1,
          options: ["Ownership of the asset", "Payment of the purchase price", "Liability (exposure to loss)", "Agreement between both parties"],
          correct: 2,
          explanation: "al-ghurm bil-ghunm: whoever carries risk of loss earns the right to profit.",
        ...
        { question: "Sort these costs: Lessor (Owner) Pays vs Lessee (You) Pay.", concept: "Items: Engine failure | Scratched bumper | Annual servicing | Fuel & oil | Insurance premium | Toner & paper", type: "column-sort", uiType: "drag-alloc", xp: 10, zone: 1,
    ...
    { id: 'lesson-2-4', title: "Ribawi vs Non-Ribawi Exchanges", description: "Know the matrix", duration: "12 min",
      conceptCards: [
        { title: "What are ribawī items?", text: "Commodities with special exchange rules: gold, silver (all currencies), staple foods.\n\nWhen you exchange ribawī items, additional safeguards apply.\n\nRegular goods (phones, cars, furniture) = normal sale rules.",
          proTip: "It's the CATEGORY that matters (currency/precious metal/staple), not the value." },
        { title: "The exchange rules", text: "Same-kind (gold for gold, USD for USD): Equal quantity AND spot delivery. Surplus = ribā al-faḍl. Delay = ribā al-nasīʾah.\n\nDifferent-kind, same category (gold for silver, USD for AED): Amount can differ, delivery must be spot.\n\nNon-ribawī (phones, cars): Normal sale rules.",
          proTip: "Same-kind: equal + spot. Different-kind: spot only. Non-ribawi: normal rules." },
        { title: "Why this matters today", text: "Every currency exchange, gold transaction, remittance involves these rules.\n\nRemittance app with 3-day delivery? Potential ribā al-nasīʾah.\n\nGold platform without real ownership? Multiple stacking defects.\n\nThe matrix is your diagnostic: classify → apply rules → spot defects.",
          proTip: "When in doubt: classify first, then apply the correct rule set." }
      ],
      questions: [
        // --- ZONE 1: WARM-UP (Q1-3) ---
        { question: "Sort: Ribawi vs Non-Ribawi.", concept: "Items: Gold bars | Used Tesla | UAE dirhams | Designer handbag | US dollars | iPhone | Silver coins | Office furniture", type: "column-sort", uiType: "drag-alloc", xp: 10, zone: 1,
          columns: [{id: "ribawi", label: "Ribawi (Special Rules)", color: "#dc2626", correct: ["Gold bars", "UAE dirhams", "US dollars", "Silver coins"]}, {id: "non-ribawi", label: "Non-Ribawi (Normal Rules)", color: "#059669", correct: ["Used Tesla", "Designer handbag", "iPhone", "Office furniture"]}],
          visual: { buckets: [{id: "ribawi", label: "Ribawi", color: "#dc2626"}, {id: "non-ribawi", label: "Non-Ribawi", color: "#059669"}], chips: [{text: "Gold bars", correct: "ribawi"}, {text: "Used Tesla", correct: "non-ribawi"}, {text: "UAE dirhams", correct: "ribawi"}, {text: "Designer handbag", correct: "non-ribawi"}, {text: "US dollars", correct: "ribawi"}, {text: "iPhone", correct: "non-ribawi"}, {text: "Silver coins", correct: "ribawi"}, {text: "Office furniture", correct: "non-ribawi"}] },
        ...
        { question: "Select TWO conditions for same-type ribawi exchange.", type: "multi-select", uiType: "sel2", xp: 10, zone: 1,
          options: ["Equal quantity", "Written documentation", "Spot (immediate) delivery", "Market-rate pricing"],
          correct: [0, 2],
          explanation: "Same-kind ribawi: equal + spot. No surplus (riba al-fadl). No delay (riba al-nasi'ah)." },
    ...
    { id: 'lesson-2-5', title: "Price, Time & Credit Sales", description: "Deferred payment ≠ interest", duration: "12 min",
      ...
      questions: [
        ...
        // --- ZONE 2: BUILD (Q4-7) ---
        { question: "Phone cash AED 3,400. 12-month total AED 3,720 (fixed at contract). Monthly? Markup?", type: "multiple-choice", uiType: "calc", xp: 15, zone: 2,
          options: ["Monthly AED 310 | Markup AED 320 (9.4% of cash price)", "Monthly AED 283 | Markup AED 320 (8.6% of credit price)", "Monthly AED 310 | Markup AED 320 (4.3% of cash price)", "Monthly AED 320 | Markup AED 440 (12.9%)"],
          correct: 0,
          explanation: "3,720÷12=310. Markup: 3,720-3,400=320. 320/3,400=9.4%.",
          trapAnalysis: "Option B uses wrong divisor. Option C gets percentage wrong.",
          visual: { calcSteps: ["Monthly = AED 3,720 ÷ 12 = AED [___]", "Markup = AED 3,720 - AED 3,400 = AED [___]", "Markup % = [___] ÷ 3,400 × 100 = [___]%"], factChips: ["Cash price: AED 3,400", "12-month total: AED 3,720", "Price fixed at: Contract signing"] } },

        { question: "Customer missed 3 TV payments. Sort: Prohibited vs Acceptable.", concept: "Items: Add AED 500 as 'late profit' | Restructure same total, clearer schedule | Compound penalty interest | At-cost admin fee AED 25", type: "column-sort", uiType: "drag-alloc", xp: 15, zone: 2,
          columns: [{id: "prohibited", label: "NOT Allowed (Riba Territory)", color: "#dc2626", correct: ["Add AED 500 to debt as late profit", "Compound: charge penalty interest on the penalty"]}, {id: "allowed", label: "Acceptable Responses", color: "#059669", correct: ["Restructure: same total, clearer schedule", "Charge documented at-cost admin fee (AED 25)"]}],
          visual: { buckets: [{id: "prohibited", label: "NOT Allowed", color: "#dc2626"}, {id: "allowed", label: "Acceptable", color: "#059669"}], chips: [{text: "Add AED 500 to debt as late profit", correct: "prohibited"}, {text: "Restructure: same total, clearer schedule", correct: "allowed"}, {text: "Compound: charge penalty interest on the penalty", correct: "prohibited"}, {text: "Charge documented at-cost admin fee (AED 25)", correct: "allowed"}] },
        ...
        { question: "Car: AED 45,000 on 24 months (cash AED 42,000). Fixed at contract. Loan or sale? Monthly?", type: "multiple-choice", uiType: "calc", xp: 15, zone: 2,
          ...
          visual: { calcSteps: ["Monthly = AED 45,000 ÷ 24 = AED [___]", "Credit markup = AED 45,000 - AED 42,000 = AED [___]"], factChips: ["Sale price: AED 45,000 (fixed at contract)", "Cash price: AED 42,000", "Term: 24 months"] } },

        { question: "In a compliant credit sale, the final price must be ______ at the point of contract.", type: "multiple-choice", uiType: "fill", xp: 15, zone: 2,
        ...
        { question: "Best response to your sister?", concept: "Sister buying bedroom set. Cash AED 12,000, instalments AED 13,800 over 18 months. 'Isn't the extra AED 1,800 just interest?'", type: "multiple-choice", uiType: "advise", xp: 20, zone: 3,
          ...
          thinkDeeper: "Apply the 'remove the asset' test: without the furniture, what's left?" }
      ]
    }
  ]
},
